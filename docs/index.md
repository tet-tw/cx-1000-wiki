...
-   :material-connection:{ .lg .middle } &nbsp;__整合方案__
    ...
    攝影機事件、外部緊急系統、校園廣播、SIP 電話的整合做法。

    [:octicons-arrow-right-24: 整合總覽](integrations/index.md)

-   :material-help-circle:{ .lg .middle } &nbsp;__故障排除 / 常見問題__

    ---

    燈號判讀、故障處置流程、症狀對照表，以及常見疑難。

    [:octicons-arrow-right-24: 故障排除](troubleshooting.md) ·
    [常見問題](faq.md)
